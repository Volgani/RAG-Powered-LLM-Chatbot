...
def display_chatbot_page():
    ...
    with st.expander("Initialize the LLM Model"):
        ...
        with st.form("setting"):
            ...
            with row_1[1]:
                llm_model = st.text_input("LLM model", value="sapienzanlp/Minerva-3B-base-v1.0")
    ...
    with st.form("document_input"):
        ...
        with row_1[0]:
            instruct_embeddings = st.text_input(
                "Model Name of the Instruct Embeddings", value="nickprock/sentence-bert-base-italian-uncased"
            )
